  ...
  <div id="app">
    <div class="all">
      ...
      <Footer
        ...
        :copyRight="
          isEnglish()
            ? customJson.copyRight.english
            : customJson.copyRight.hindi
        "
        :developerName="
          isEnglish()
            ? customJson.developerName.english
            : customJson.developerName.hindi
        "
      />
    </div>
  </div>
...
import Logo from "./assets/icons/bbc.logo.png";
